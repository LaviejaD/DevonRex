...
impl Status {
    pub fn to_string(&self) -> String {
        match self {
            ...
            | Status::MovePermanently => String::from("301 Moved Permanently"),
            ...
            | Status::ExpectationFailed => String::from("417 Expectation Failed"),
            ...
            | Status::VariantAlsoNegotiates => String::from("506 Variant Also Negotiattes"),
